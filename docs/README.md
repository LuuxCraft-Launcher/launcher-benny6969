...
<h1 align="center">voxel studios</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Voxel-Studios-win-x64.exe ` |
| macOS | `Voxel-Studios-mac-universal.dmg` |
| Linux x64 | `Voxel-Studios-linux-x86_64.AppImage` |
